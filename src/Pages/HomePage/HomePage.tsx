    ...
    <Center w="100%" h="100%">
      <Stack justify="center" align="center" className={styles.homeWrapper} maw={1000}>
        ...
        <Text size="xl" ta="center">
          ...
          for the <Anchor href={LINKS.LIB_REPO}>LocalBoast React Library</Anchor>, as well as some of the utilities I've
          built using it{" "}
          <Anchor component={Link} to="/apps/sketch">
            (see sneak-peek)
          </Anchor>
          .
          <br />
          ...
          live-streams on <Anchor href={LINKS.TWITCH}>Twitch</Anchor> and <Anchor href={LINKS.YOUTUBE}>YouTube</Anchor>{" "}
          and my <Anchor href={LINKS.DISCORD}>Discord Community</Anchor>.
          <br />
          <br />
          Follow my progress at the links above to see this develop and consider supporting my project by{" "}
          <Anchor href={LINKS.KO_FI}>Buying me a coffee</Anchor>,{" "}
          <Anchor href={LINKS.SE_TIP}>Tipping me live on stream</Anchor>, or{" "}
          <Anchor href={LINKS.PATREON}>becoming a recurring Patron</Anchor>.
        </Text>
      </Stack>
    </Center>
  );
